                ...
                <div class="features_items"><!--features_items-->
                    <h2 class="title text-center"><?=$category->name?></h2>
                        ...
                        <?php $i = 0; foreach ($products as $product): ?>
                            <?php $l = $product->productLang; ?>
                                <?php foreach($l as $la): ?>
                                    <?php if($la->lang == Yii::$app->language): ?>
                                        <div class="col-sm-4">
                                            <div class="product-image-wrapper">
                                                <div class="single-products">
                                                    <div class="productinfo text-center">
                                                        ...
                                                        <h2>$ <?=$product->price?></h2>
                                                        <p><a href="<?= \yii\helpers\Url::to(['product/view', 'id' => $la->id]) ?>"> <?=$la->title?> </a></p>
                                                        <a href="#" data-id="<?= $la->id ?>" class="btn btn-fefault add-to-cart cart">
                                                ...
                                                <div class="choose">
                                                    <ul class="nav nav-pills nav-justified">
                                                        <li>
                                                            <a href="<?= \yii\helpers\Url::to(['wishlist/add', 'id'=>$la->id]) ?>">
